...
{
	return @[[NSURLQueryItem queryItemWithName:@"x-success" value:@"xcall-andy-matuschak-bear-link-janitor://x-callback-url/handle-success"],
			 [NSURLQueryItem queryItemWithName:@"x-error" value:@"xcall-andy-matuschak-bear-link-janitor://x-callback-url/handle-error"]];
}
